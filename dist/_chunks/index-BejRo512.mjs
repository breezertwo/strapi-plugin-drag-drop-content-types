...
const SortableList = ({ data, onShowMore, hasMore, settings, onSortEnd }) => {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx("div", { style: { maxHeight: "800px", overflow: "auto" }, children: /* @__PURE__ */ jsx(
      DndContext,
      {
        sensors,
...
const index = {
      ...
      [
        {
          ...
          id: "settings",
          to: `${PLUGIN_ID}`,
          Component: () => import("./Settings-hfGkHssq.mjs")
        }
      ]
    );
    app.registerPlugin({
  ...
  async registerTrads(app) {
    ...
    const importedTranslations = await Promise.all(
      locales.map((locale) => {
        return __variableDynamicImportRuntimeHelper(/* @__PURE__ */ Object.assign({ "./translations/en.json": () => import("./en-DcurWu3j.mjs") }), `./translations/${locale}.json`).then(({ default: data }) => {
          return {
...
//# sourceMappingURL=index-BejRo512.mjs.map
