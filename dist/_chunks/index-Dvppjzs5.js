...
const SortModal = () => {
  ...
  const refetchEntries = React__namespace.default.useCallback(
...
const index = {
      ...
      [
        {
          ...
          id: "settings",
          to: `${PLUGIN_ID}`,
          Component: () => Promise.resolve().then(() => require("./Settings-SMhNIwxY.js"))
        }
      ]
    );
    app.registerPlugin({
  ...
  async registerTrads(app) {
    ...
    const importedTranslations = await Promise.all(
      locales.map((locale) => {
        return __variableDynamicImportRuntimeHelper(/* @__PURE__ */ Object.assign({ "./translations/en.json": () => Promise.resolve().then(() => require("./en-I3-CH3Sy.js")), "./translations/fr.json": () => Promise.resolve().then(() => require("./fr-C8Qw4iPZ.js")) }), `./translations/${locale}.json`).then(({ default: data }) => {
          return {
...
exports.index = index;
//# sourceMappingURL=index-Dvppjzs5.js.map
